(function ($) {
    ...
    $("#searchButton").click(function () {
        ...
        $.get(`/food-api/restaurant/search?query=${query}`, function (response) {
    ...
    function getWishList(){
        $.get(`/food-api/restaurant/all`, function (response) {
